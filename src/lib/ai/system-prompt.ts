...
- particleSize: pixels (1-100, default 10)
- particleColor: CSS color string
- velocity: { x: number, y: number } - initial velocity
...
- spawnArea: { width: number, height: number } - spawn rectangle
...
- For ParticleSystem: position is the TOP-LEFT of the spawn area. To center particles behind centered text, calculate: x = 960 - spawnArea.width/2, y = 540 - spawnArea.height/2.
